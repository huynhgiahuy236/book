...
export const dacNhanTamBook: Book = {
  ...
  description: "Tác phẩm kinh điển về nghệ thuật giao tiếp, thấu hiểu con người và xây dựng những mối quan hệ bền vững.",
  accessType: "PURCHASE",
  readingEnabled: true,
  stock: 0,
  ebookPrice: 69000,
...
export const books: Book[] = [dacNhanTamBook, ...importedBooks.slice(0, 23).map<Book>((book, index) => ({
